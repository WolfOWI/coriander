     ...
     <div
            ...
            {/* Top row: Icon, leave type/days, and status badge */}
              <div className="flex items-start justify-between">
                ...
                <div>
                  <p className="font-semibold text-zinc-900">{req.leaveTypeName}</p>
                  <p className="text-sm text-zinc-600">{20}</p> 
            ...
            {/* Bottom section: Dates and comment */}
              <div>
                <p className="text-sm text-zinc-800 mt-3">{`${req.startDate} - ${req.endDate}`}</p>
