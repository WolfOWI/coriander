...
function TerminateEmployeeModal({ showModal, setShowModal }: TerminateEmployeeModalProps) {
  return (
    <Modal
    ...
    >
      <div className="flex flex-col gap-2 text-center">
        <h2 className="text-red-600 font-bold text-2xl">You're about to delete Lettie Dlamini.</h2>
