...
const EmployeeHome: React.FC = () => {
  ...
  const fetchEmployeeData = async () => {
    try {
        const response = await empUserAPI.getEmpUserById('8');
      ...
      "$values": [
        {
          ...
          "description": "Leave granted to employees needing to attend urgent family-related matters or responsibilities.",
          "defaultDays": 5
        },
        {
          "$id": "3",
          ...
          "remainingDays": 8,
          "leaveTypeName": "Study",
          "description": "Leave provided to employees undertaking formal educational or professional development activities related to their role.",
          "defaultDays": 8
        },
        {
          "$id": "4",
          ...
          "description": "Paid leave provided annually to employees for rest and personal activities, typically scheduled in agreement with management.",
          "defaultDays": 15
        },
        {
          "$id": "5",
          ...
          "remainingDays": 5,
          "leaveTypeName": "Sick",
          "description": "Leave taken when an employee is unable to perform work duties due to illness, injury, or medical treatment.",
          "defaultDays": 10
        },
        {
          "$id": "6",
          ...
          "description": "Leave provided to employees following the birth or adoption of a child, allowing time for caregiving and bonding.",
          "defaultDays": 60
        },
        {
          "$id": "7",
          ...
          "description": "Leave granted due to the death, serious illness, or emergency situation involving immediate family members or close relationships.",
          "defaultDays": 3
        }
      ]
    }
        ...
        <Row>
          <Col md={8}>
            ...
            <Row className="g-3 pt-3">
              <Col xs={12} md={12}>
              <div className="text-zinc-500 font-semibold text-center mb-2">Payroll Information</div>
                <div className="bg-warmstone-50 p-4 pt-2 rounded-2xl shadow">
                  <div className="w-full flex flex-col gap-2 items-center">
                    <div className="bg-warmstone-50 p-2 rounded-2xl w-full flex flex-col items-center">
                        ...
                        <div className="flex flex-col items-center p-3 bg-warmstone-200 w-full rounded-2xl">
                          <p className="text-zinc-900 text-xl">{formatRandAmount(100)}</p>
                          ...
                          <div className="flex flex-col w-1/2 items-center">
                            ...
                            <div className="flex justify-center items-center gap-2 p-4 bg-white hover:bg-corigreen-500 border-2 border-corigreen-500 rounded-2xl w-full">
                              <div className="flex items-center">
                                ...
                                <p className="text-corigreen-500 text-sm">Export Payroll</p>
                              </div>
                            </div>
                            {/* {nextPayDay && (
                              <div className="flex justify-center items-center gap-2 p-4 bg-warmstone-200 w-full rounded-2xl h-full">
