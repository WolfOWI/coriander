        ...
        <div className="flex gap-4">
          <div className="max-w-1/2 min-w-1/2 w-1/2 flex flex-col gap-4">
            ...
            <div className="w-full flex flex-col gap-2 items-center relative">
              ...
              <div
                className={`bg-warmstone-50 px-4 pt-4 rounded-2xl w-full flex flex-col items-center gap-4 overflow-y-auto scrollbar-hide [&::-webkit-scrollbar]:hidden  shadow-sm
